...
if (isset($_POST['submit']))
{
	...
	$sql="Insert into `DOCUMENT_TABLE` (`NAME`,`CREATEDATE`,`ARCHIVESTATUS`,`FILETYPE`,`CONTENT`,`UPLOADBY`) values ('$fileName','$uploadDate','active','$docType','$contentsClean',$uploadBy)";
	$dblink->query($sql) 	or
	...
	//fwrite($fp,$content);
	//fclose($fp);
	header("http://192.168.56.102/upload.php?msg=success");
}
?>